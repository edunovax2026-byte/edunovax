...
async function openNotesList(subject, semester) {
    ...
    try {
        ...
        querySnapshot.forEach((doc) => {
            ...
            // 🌟 FULL SCREEN A4 READER SETTINGS 🌟
            if (note.type === 'link') {
                const readBtn = document.createElement('button');
                readBtn.className = 'neon-btn'; readBtn.innerText = 'View Document';
                readBtn.onclick = () => {
                    document.getElementById('text-note-title').innerText = ''; 
                    ...
                    document.getElementById('text-note-body').innerHTML = `
                        <div class="a4-paper">
                            <div class="pdf-page-border">
                                ...
                                <div style="position: relative; width: 100%; height: 75vh; min-height: 500px; border-radius: 5px; overflow: hidden; background: #f8f9fa; border: 1px solid #bdc3c7;">
